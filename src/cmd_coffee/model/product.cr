module CmdCoffee::Model
  class Product
    JSON.mapping(
      ...
      price_usd: {key: "priceUsd", type: Float64, nilable: false},
      weight_in_ounces: {key: "weightInOunces", type: Float64, nilable: false},
      description: {key: "description", type: String, nilable: true},
      tasting_notes: {key: "tastingNotes", type: String, nilable: true},
    )
